...
%
\\
\>\AgdaKeyword{module} \AgdaModule{RandomAccessSequence-final} \AgdaKeyword{where}\<%
\\
%
\\
\>[0]\AgdaIndent{4}{}\<[4]%
...
\\
\>[0]\AgdaIndent{6}{}\<[6]%
\>[6]\AgdaFunction{property} \AgdaBound{xs} \AgdaSymbol{=} \AgdaSymbol{?} \<[22]%
\>[22]\<%
\\
\>[0]\AgdaIndent{6}{}\<[6]%
...
\\
\>[0]\AgdaIndent{6}{}\<[6]%
\>[6]\AgdaFunction{inductive-step} \AgdaBound{seq} \AgdaBound{x} \AgdaBound{xs} \AgdaBound{prop} \AgdaBound{p} \AgdaSymbol{=} \AgdaSymbol{?}\<%
\\
\>[0]\AgdaIndent{6}{}\<[6]%
...
\\
\>[0]\AgdaIndent{4}{}\<[4]%
\>[4]\AgdaFunction{main} \AgdaSymbol{:} \AgdaPostulate{IO} \AgdaDatatype{ℕ}\<%
\\
\>[0]\AgdaIndent{4}{}\<[4]%
...
\\
\>[4]\AgdaIndent{12}{}\<[12]%
\>[12]\AgdaSymbol{(λ} \AgdaBound{x} \AgdaSymbol{→} \AgdaPostulate{putStrLn} \AgdaSymbol{(}\AgdaFunction{toCostring} \AgdaSymbol{(}\AgdaFunction{show-maybe}\AgdaSymbol{(}\AgdaFunction{revst4}\AgdaSymbol{))))} \AgdaPostulate{>>=}\<%
\\
\>[4]\AgdaIndent{12}{}\<[12]%
