...
\subsection{\AgdaFunction{reversing} and problems with the compiler}
...
\item foldl-dig. Folding a Digit from the left 
...
\item The implementations of toList-node and foldl-node proceed analogously to cases \AgdaInductiveConstructor{Two} and \AgdaInductiveConstructor{Three} in the \textit{Digit} versions.
\end{itemize}
