...
\tikzset{
  ...
  deep/.style = {treenode, circle, red, draw=red,
  	minimum width=0.5em, minimum height=0.7em, fill=red},
  node/.style = {treenode, circle, green, draw=green,
  	minimum width=0.5em, minimum height=0.7em, fill=green},
  digit/.style = {treenode, white, draw=blue, 
  	minimum width=0.4em, minimum height=0.4em, fill=blue},
  leaf/.style = {treenode, white, draw = blue, 
  	circle, minimum width = 0.4em, minimum height = 0.4em, fill=blue}
}
...
\subsection{Proving Correctness of ViewL}
